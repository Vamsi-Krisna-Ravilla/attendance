...
def mark_attendance_page():
    """Enhanced attendance marking page with improved UI"""
    ...
    if section and period and subject:
        ...
        # Add "Mark All Present" and "Mark All Absent" buttons
        col1, col2, col3 = st.columns(3)
        with col1:
            mark_all_present = st.button("✓ Mark All Present", type="primary", key="mark_all_present")
        with col2:
            mark_all_absent = st.button("✗ Mark All Absent", key="mark_all_absent")
        with col3:
            use_last_pattern = st.button("↺ Use Last Pattern", key="use_last_pattern")
        ...
        if mark_all_present:
            ...
            # Implement the logic to get and use the last attendance pattern
            # For now, we'll just show a placeholder message
            st.info("Last attendance pattern feature is not implemented yet.")
